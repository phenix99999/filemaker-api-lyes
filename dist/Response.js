...
exports.FMResponse = void 0;
var FMResponse = /** @class */ (function () {
    function FMResponse(xmlResponse) {
        ...
        if (xmlResponse.count === undefined)
            return;
        if (xmlResponse.records === undefined)
            return;
        this.count = xmlResponse.count;
        this.records = xmlResponse.records.map(function (record) { return ({
            id: record.id,
            fields: record.fields
        }); });
    }
    FMResponse.prototype.hasError = function () {
        return this.code !== 0 && this.code !== 401;
    };
    FMResponse.prototype.isEmpty = function () {
        return this.code === 401;
    };
    FMResponse.prototype.throwError = function () {
        var _this = this;
        var error = ERRORS.find(function (error) { return error.code === _this.code; });
        throw new Error("Filemaker error code " + (error === null || error === void 0 ? void 0 : error.code) + " " + (error === null || error === void 0 ? void 0 : error.message));
    };
    return FMResponse;
}());
exports.FMResponse = FMResponse;
var ERRORS = [
